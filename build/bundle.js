...
;// ./src/VideoTemplate/ComparisonCard.tsx




const LayerComponent = ({ layer, idx, item, onAssetLoad }) => {
  if (!layer) return null;
  const replaceTextFormat = (format, itm) => {
    let text = (format || "").replace(/{country}/g, itm.country || "").replace(/{itemName}/g, itm.itemName || "").replace(/{value}/g, itm.value !== void 0 && itm.value !== null ? itm.value.toString() : "");
    if (itm.extraData) {
  ...
  switch (layer.type) {
    ...
    case "rank":
    case "text":
      const content = layer.type === "country" ? item.country : layer.type === "name" ? item.itemName : layer.type === "rank" ? item.rank : replaceTextFormat(layer.textFormat || "", item);
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        ...
        lineHeight: 1.1,
        overflow: "visible"
      }, children: content }, layer.id || `layer-${idx}`);
    case "image":
    case "flag":
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        ...commonStyle,
        borderRadius: layer.imageShape === "circle" ? "50%" : layer.imageShape === "pill" ? 1e3 : layer.borderRadius || 0,
      ...
      }, children: src && !hasError ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "img",
        {
          src,
          onLoad: onAssetLoad,
      ...
      ) : /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 12, color: "white", textAlign: "center", padding: 10 }, children: layer.type.toUpperCase() }) }, layer.id || `layer-${idx}`);
    case "shape":
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        ...commonStyle,
...
const ComparisonCard = ({ item, theme, isFullPage = false }) => {
  var _a;
  const [handle] = react.useState(() => (0,esm.delayRender)("Loading assets..."));
  const [assetsLoaded, setAssetsLoaded] = react.useState(0);
  const layers = ((_a = item == null ? void 0 : item.overrides) == null ? void 0 : _a.layers) || (theme == null ? void 0 : theme.layers) || [];
  const imageLayers = layers.filter((l) => (l == null ? void 0 : l.type) === "image" || (l == null ? void 0 : l.type) === "flag");
  ...
  const borderRadius = overrides.cardBorderRadius ?? (currentShape === "pill" ? 1e3 : currentShape === "rounded" ? 30 : 0);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
    ...
    "div",
    {
      ...
      children: [
        overrides.layers || theme.layers ? (overrides.layers || theme.layers).map((layer, idx) => /* @__PURE__ */ (0,jsx_runtime.jsx)(LayerComponent, { layer, idx, item, onAssetLoad }, layer.id || idx)) : /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { padding: 40, color: "white", fontSize: 24, textAlign: "center" }, children: "No Layers Configured" }),
        !theme.layers && (theme.textBadges || []).map((badge) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
          position: "absolute",
          left: `${badge.x}%`,
          top: `${badge.y}%`,
          transform: "translate(-50%, -50%)",
          ...
          borderRadius: badge.shape === "pill" ? 1e3 : badge.shape === "rounded" ? badge.padding : "50%",
          display: "flex",
          justifyContent: "center",
          alignItems: "center",
          textAlign: "center",
          ...
          whiteSpace: "nowrap",
          zIndex: 100
        }, children: replaceTextFormat(badge.textFormat, item) }, badge.id))
      ]
    }
  ) });
};
...
const getTheme = (themeNameOrConfig) => {
...
;// ./src/VideoTemplate/ComparisonRace.tsx





const ComparisonRace = ({ items, title, theme }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { width, durationInFrames } = (0,esm.useVideoConfig)();
  ...
  const translateX = (0,esm.interpolate)(
    frame,
    [0, durationInFrames],
    [width / 2 - dynamicCardWidth / 2, -(totalWidth - width / 2 - dynamicCardWidth / 2)],
    { extrapolateRight: "clamp" }
  );
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#111", display: "flex", flexDirection: "column" }, children: [
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "h1",
          {
            style: {
              ...
              textAlign: "center",
              textTransform: "uppercase",
              textShadow: (activeTheme.titleShadow || "none").replace(/8px/g, "4px").replace(/16px/g, "8px"),
              margin: 0
            },
            children: title
          }
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        children: items.map((item) => /* @__PURE__ */ (0,jsx_runtime.jsx)(ComparisonCard, { item, theme: activeTheme }, item.id))
      }
    )
  ] });
};
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(192), __webpack_require__.e(845)]).then(__webpack_require__.bind(__webpack_require__, 6192)).then(({ StudioInternals }) => {
...
var PremountedPostmountedSequenceRefForwardingFunction = (props, ref) => {
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(PremountContext.Provider, {
    value: premountContextValue,
    children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(Freeze, {
      frame: freezeFrame,
...
var SharedAudioContextProvider = ({ children, numberOfAudioTags, audioLatencyHint, audioEnabled }) => {
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(SharedAudioContext.Provider, {
    value,
    children: [
      refs.map(({ id, ref }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "comparison-video:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcomparison_video"] = self["webpackChunkcomparison_video"] || [];
